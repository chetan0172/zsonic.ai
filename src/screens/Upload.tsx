...
import { Upload as UploadIcon, Youtube, FileText, Mic, Video } from 'lucide-react';
    ...
    try {
      ...
      xhr.upload.addEventListener('load', async () => {
        try {
          ...
          const response = await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/process-content`, {
            method: 'POST',
            headers: {
